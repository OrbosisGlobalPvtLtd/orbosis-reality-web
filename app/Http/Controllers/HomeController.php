...
class HomeController extends Controller
{
    ...
    public function index(Request $request)
    {
        ...
        $slider_properties = Property::select('id', 'title', 'slug', 'purpose', 'rent_period', 'price', 'thumbnail_image', 'address', 'total_bedroom', 'total_bathroom', 'total_area', 'status', 'show_slider', 'serial', 'availability_status')
            ->where('status', 'enable')
        ...
        $urgent_properties = Property::with('agent')
            ->select('id', 'agent_id', 'title', 'slug', 'purpose', 'rent_period', 'price', 'thumbnail_image', 'address', 'total_bedroom', 'total_bathroom', 'total_area', 'status', 'is_featured', 'is_urgent', 'video_id', 'availability_status')
            ->where('status', 'enable')
