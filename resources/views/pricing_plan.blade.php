                            ...
                            <div class="homec-psingle__body">
                                <ul class="homec-psingle__list">
                                    ...
                                    @if ($pricing_plan->max_agent_add > 0)
                                        ...
                                        <li><span class="homec-psingle__icon homec-check-color"><i class="fas fa-check"></i></span>{{ $pricing_plan->max_agent_add == -1 ? __('user.Unlimited') : $pricing_plan->max_agent_add }} {{__('user.Agent')}}</li>
                                    @else
                                    ...
                                    @if ($pricing_plan->featured_property == 'enable' && $pricing_plan->featured_property_qty != 0)
                                    ...
                                    @if ($pricing_plan->top_property == 'enable' && $pricing_plan->top_property_qty != 0)
                                    ...
                                    @if ($pricing_plan->urgent_property == 'enable' && $pricing_plan->urgent_property_qty != 0)
                                    ...
                                    @if ($pricing_plan->is_featured_badge_allowed ?? 0)
