                        ...
                        <div class="property-sidebar">
                            ...
                            <div class="property-sidebar__single mg-top-20">
                                <div class="property-sidebar__filters">
                                    ...
                                    <div class="form-group" id="country_selector">
                                        <select class="property-sidebar__group homec-border select2 city_location select_search"
                                            name="city">
                                            <option value="">{{ __('user.Select') }}</option>
                                        </select>
                                    </div>
                            ...
                            <div class="property-sidebar__single mg-top-20">
                                <div class="property-sidebar__filters">
                                    ...
                                    <div class="form-group">
                                        <select class="property-sidebar__group homec-border select2 select_search" name="type">
